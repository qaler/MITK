  ...
  */
  ...
  public:
    ...
    */
    ...
    const mitk::ContourModel::VertexType *GetNextVertexAt(mitk::Point3D &point, float eps, TimeStepType timestep) const;

    const mitk::ContourModel::VertexType *GetPreviousVertexAt(mitk::Point3D &point,
                                                              float eps,
